...
const Task = ({task} : TaskProps) => {
    ...
    const formattedStartedDate = task.startDate ? format(new Date(task.startDate), "P") : "";
        ...
        <div ref={(intance) => {drag(intance)}} className={`mb-4 rounded-md bg-white shadow dark:bg-dark-secondary ${isDragging ? "opacity-50" : "opacity-100"}`}>
            ...
            <div className='p-4 md:p-6'>
                <div className='flex items-start justify-between'>
                    ...
                    <button className='flex h-6 w-4 flex-shring-0 items-center justify-center dark:text-neutral-500'>
                            <EllipsisVertical size={26} />
                    </button>
                </div>
                ...
                <div className='text-xs text-gray-500 dark:text-neutral-500'>
                    {formattedStartedDate && <span>{formattedStartedDate} - </span>}
                ...
                <div className='mt-3 flex items-center justify-between'>
                    ...
                    <div className='flex items-center text-gray-500 dark:text-neutral-500'>
                        ...
                        <span className='ml-1 text-sm dark:txet-neutral-400'>
                            {numberOfComments}
                        </span>
                    </div>
                </div>
